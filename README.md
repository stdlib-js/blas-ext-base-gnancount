...
```javascript
import nancount from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-strided-nancount@deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { ndarray } from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-strided-nancount@deno/mod.js';
```
